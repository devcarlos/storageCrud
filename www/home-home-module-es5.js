...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomePage = /*#__PURE__*/function () {
      ...
      _createClass(HomePage, [{
        ...
        value: function updateItem(item) {
          ...
          item.title = "UPDATED: ".concat(item.title);
          item.modified = Date.now();
          this.storageService.updateItem(item).then(function (item) {
            _this4.showToast('Item Updated!');
        ...
        value: function deleteItem(item) {
          ...
          this.storageService.deleteItem(item).then(function (item) {
            _this5.showToast('Item Deleted!');

            _this5.mylist.closeSlidingItems();
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('mylist')], HomePage.prototype, "mylist", void 0);
      ...
      _createClass(StorageService, [{
        ...
        value: function addItem(item) {
          ...
          return this.storage.get(ITEMS_KEY).then(function (items) {
            if (items) {
              items.push(item);
              return _this6.storage.set(ITEMS_KEY, items);
            } else {
              return _this6.storage.set(ITEMS_KEY, [item]);
            }
          });
        } // Read
        ...
        value: function updateItem(item) {
          ...
          return this.storage.get(ITEMS_KEY).then(function (items) {
            ...
            return _this7.storage.set(ITEMS_KEY, newItems);
          });
        } // Delete
        ...
        value: function deleteItem(item) {
          ...
          return this.storage.get(ITEMS_KEY).then(function (items) {
            ...
            var keepItems = items.filter(function (element) {
              return element.id !== item.id;
            });
            console.log('KEEP ITEMS => ', keepItems);
            return _this8.storage.set(ITEMS_KEY, keepItems);
          });
        }
      }]);
